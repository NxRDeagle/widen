    ...
    return (
        <div className={true ? "confirmation_box confirmation_box_open" : "confirmation_box"}>
            ...
            <div className='confirmation_options_box'>
                <button onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} onTouchMove={handleTouchEnd} className='confirmation_options_btn'>Нет</button>
                <button onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} onTouchMove={handleTouchEnd} className='confirmation_options_btn'>Да</button>
            </div>
        </div>
    )
}