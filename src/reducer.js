export function reducer(state, { type, payload }) {
  switch (type) {
    ...
    case 'CLEAR_PARTNERSHIP_FILTERS':
      return {
        ...state,
        partnershipFilters: {
          tags: [],
      ...
      switch (payload.category) {
        case 'tags':
          return {
            ...
            partnershipFilters: {
              ...
              tags: state.partnershipFilters.tags.filter(
        ...
        case 'duration':
          return {
            ...
            partnershipFilters: {
              ...state.partnershipFilters,
              duration: state.partnershipFilters.duration.filter(
                (obj) => obj !== payload.partnershipFilter,
              ),
            },
          };
        case 'format':
          return {
            ...
            partnershipFilters: {
              ...state.partnershipFilters,
              format: state.partnershipFilters.format.filter(
                (obj) => obj !== payload.partnershipFilter,
              ),
            },
          };
        case 'direction':
          return {
            ...
            partnershipFilters: {
              ...state.partnershipFilters,
              direction: state.partnershipFilters.direction.filter(
                (obj) => obj !== payload.partnershipFilter,
              ),
            },
          };
        case 'type':
          return {
            ...
            partnershipFilters: {
              ...state.partnershipFilters,
              type: state.partnershipFilters.type.filter(
                (obj) => obj !== payload.partnershipFilter,
              ),
            },
          };
    ...
    case 'SET_CHANGE_MSG':
      return {
        ...state,
        changeMsgs: state.changeMsgs.find((changeMsg) => changeMsg.messageId === payload.messageId)
          ? state.changeMsgs.filter((changeMsg) => changeMsg.messageId !== payload.messageId)
          : [...state.changeMsgs, payload],
        replyDialogMsg: false,
        forwardedDialogMsgs: [],
        footType: 'editorMsg',
      };
