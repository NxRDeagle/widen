      ...
      }
      {
        inputStates.activeBox === 3 && (
          <div className="input_container" style={{ backgroundImage: 'url()' }}>
            ...
            <button
              className={inputStates.userCategory === 'professional' ? 'choose_who your_choose' : 'choose_who '}
              onClick={() => {
                setInputStates({
                  ...inputStates,
            ...
            <button
              className={inputStates.userCategory === 'customer' ? 'choose_who your_choose' : 'choose_who '}
              onClick={() => {
                setInputStates({
                  ...inputStates,
            ...
            <button
              className={inputStates.userCategory === 'organisation' ? 'choose_who your_choose' : 'choose_who '}
              onClick={() => {
                setInputStates({
                  ...inputStates,
      ...
      }
      {
        inputStates.activeBox === 5 && (
          <div className="more">
            ...
            <button onClick={goHome} className="more_ready">Готово</button>
          </div>
        )
      }
    </>
