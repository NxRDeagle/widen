        ...
        <>
            ...
            <li name='record_creation' className={profileActiveIcon === 'record_creation' ? 'profile_icon_box profile_icon_box_active' : 'profile_icon_box'}>
                <svg name='record_creation' style={{ marginLeft: '6px' }} xmlns="http://www.w3.org/2000/svg" width="35" height="26" viewBox="0 0 35 26" fill="none">
                    ...
                    <line name='record_creation' x1="18.0541" y1="14.8358" x2="34.0541" y2="1.83583" stroke={profileActiveIcon === 'record_creation' ? 'black' : '#BABABA'} strokeWidth="3" />
                </svg>
            </li>
            <li name='metric' className={profileActiveIcon === 'metric' ? 'profile_icon_box profile_icon_box_active' : 'profile_icon_box'}>
                <svg name='metric' xmlns="http://www.w3.org/2000/svg" width="26" height="24" viewBox="0 0 26 24" fill="none">
                    <path name='metric' d="M13.6318 0V24.0001" stroke={profileActiveIcon === 'metric' ? 'black' : '#BABABA'} strokeWidth="2" />
                    <path name='metric' d="M25 11.4336L0.999999 11.3682" stroke={profileActiveIcon === 'metric' ? 'black' : '#BABABA'} strokeWidth="2" />
                    <path name='metric' d="M4.15816 11.3685C3.94763 8.42113 5.54764 2.52637 13.6319 2.52637" stroke={profileActiveIcon === 'metric' ? 'black' : '#BABABA'} strokeWidth="2" />
                    <path name='metric' d="M13.6318 5.05251C15.7371 4.84198 19.9476 5.81041 19.9476 11.3683" stroke={profileActiveIcon === 'metric' ? 'black' : '#BABABA'} strokeWidth="2" />
                    <path name='metric' d="M5.4209 11.3682C5.4209 14.3155 7.06301 20.2103 13.6315 20.2103" stroke={profileActiveIcon === 'metric' ? 'black' : '#BABABA'} strokeWidth="2" />
                    <path name='metric' d="M19.7831 11.4785C19.957 13.5655 19.0527 17.7394 14.0439 17.7394" stroke={profileActiveIcon === 'metric' ? 'black' : '#BABABA'} strokeWidth="2" />
                </svg>
            </li>
