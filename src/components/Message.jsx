...
const Message = (props) => {
  ...
  const companion = users_data.find((obj) => obj.userId === (Message.companionId === userId ? companionsId[0] : Message.companionId))
    ? users_data.find((obj) => obj.userId === (Message.companionId === userId ? companionsId[0] : Message.companionId))
    : defaultUser;
  ...
  return (
    <div className="chat_box">
      ...
      <div className="chat_user_avatar_box">
        <img className="avatar_picture" src={conversationAvatar ? conversationAvatar : companion.avatar} alt={conversationName ? conversationName : companion.nickname} />
      </div>
