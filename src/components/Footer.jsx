        ...
        <ul
          ...
          <Link to="/">
            <li
              ...
              <i name="icon-posts" className="icon-posts"></i>
            </li>
          </Link>
          <Link to="/vacancies">
            <li id="vacancies" className={page === 'vacancies' ? 'icon_target' : ''}>
              <i name="icon-vacancies" className="icon-vacancies"></i>
            </li>
          </Link>
          <Link to="/messenger">
            <li id="messenger" className={page === 'messenger' ? 'icon_target' : ''}>
              <i name="icon-messenger" className="icon-messenger"></i>
            </li>
          </Link>
          <Link to="/help">
            <li id="help" className={page === 'help' ? 'icon_target' : ''}>
              <i name="icon-help">
                <svg name="icon-help" width="35" height="25" viewBox="0 0 35 25" fill="none">
                  <path
                    name="icon-help"
                    fillRule="evenodd"
                    clipRule="evenodd"
          ...
          <Link to="/profile">
            <li id="profile" className={page === 'profile' ? 'icon_target' : ''}>
              <i name="icon-profile" className="icon-profile"></i>
            </li>
          </Link>
        </ul>
      ) : (
        <ul className="nav_comment_items">
          <li>
