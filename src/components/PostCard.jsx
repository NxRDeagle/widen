          ...
          <div className="post_sign">
            ...
            {!full && isActionsOpened && (
              <div className="actions_container">
                ...
                <div
                  className={selectedAction === 4 ? 'action_div action_is_selected' : 'action_div'}
          ...
          {full && tags ? (
            <div className="tags_box">
              {tags.map((item, index) => {
                return (
                  <button
                    onClick={(e) => clickGlobalFilter('globalPost', e.target.textContent, 'tag')}
                    key={index}
                    className="tag">
                    {item}
                  </button>
