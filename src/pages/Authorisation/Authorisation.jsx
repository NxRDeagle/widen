                        ...
                        <div id='login_container' className='authorisation_container_main'>
                            ...
                            < form className='authorisation_form_box' onSubmit={(e) => e.preventDefault()}>
                                {
                                    activeLoginBox === 'login' && (
                                        <>
                                            ...
                                            <AuthInput onFocus={handleFocus} onChange={handleChange} name='login' className={loginStates.error ? 'authoristaion_text_input error_login' : 'authoristaion_text_input'} placeholder='Логин*'></AuthInput>
                                            <PswdInput onFocus={handleFocus} onChange={handleChange} name='password' placeholder='Пароль*' className={loginStates.error ? 'authoristaion_password_input error_login' : 'authoristaion_password_input'}></PswdInput>
                                            <SubmitBtn>Войти</SubmitBtn>
                                            <p className={loginStates.error ? 'error_label' : 'none_active'}>Логин или пароль неверны</p>
                                            <p onClick={() => setLoginBox('recmail')} className='forgot_pswd_link'>Забыли пароль?</p>
                                        </>
                                    )
                                }
                                {
                                    activeLoginBox === 'regmail' && (
                                        <>
                                            ...
                                            <AuthInput onFocus={handleFocus} onChange={handleChange} name='email' className={loginStates.error ? 'authoristaion_text_input error_login' : 'authoristaion_text_input'} placeholder='Эл.Почта*'></AuthInput>
                                ...
                                }
                                {
                                    activeLoginBox === 'regpswd' && (
                                        <>
                                            ...
                                            <PswdInput onFocus={handleFocus} onChange={handleChange} name='password' placeholder='Вот тут придумайте*' className={loginStates.error ? 'authoristaion_password_input error_login' : 'authoristaion_password_input'}></PswdInput>
                                            <PswdInput onFocus={handleFocus} onChange={handleChange} name='secondpassword' placeholder='Вот тут повторите*' className={loginStates.error ? 'authoristaion_password_input error_login' : 'authoristaion_password_input'}></PswdInput>
                                            <SubmitBtn>Продолжить</SubmitBtn>
                                ...
                                }
                                {
                                    activeLoginBox === 'regnick' && (
                                        <>
                                            ...
                                            <AuthInput onFocus={handleFocus} onChange={handleChange} name='nickname' className={loginStates.error ? 'authoristaion_text_input error_login' : 'authoristaion_text_input'} placeholder='Никнейм*'></AuthInput>
                                            <SubmitBtn>Продолжить</SubmitBtn>
                                            <p className={loginStates.error ? 'error_label' : 'none_active'}>Никнейм неверен или уже занят</p>
                                        </>
                                    )
                                }
                                {
                                    activeLoginBox === 'regcategory' && (
                                        <>
                                            ...
                                            <p className={loginStates.error ? 'error_label' : 'none_active'}>Категория не выбрана</p>
                                        </>
                                    )
                                }
                                {
...

                            {
                                ['login', 'regmail'].includes(activeLoginBox) && (
                                    <LoginLink onClick={() => setLoginBox(activeLoginBox === 'login' ? 'regmail' : 'login')} link={activeLoginBox === 'login' ? 'Зарегистрироваться' : 'Войти'}>
